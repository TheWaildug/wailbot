...
module.exports ={
    ...
    execute(message,args,Discord,client){
        ...
        memberto.ban({ days: 7, reason: args[1] })
            ...
            mentionMember.send(`You have been banned from ${message.channel.guild}. Reason: ${args[1]}. To become unrestricted, please DM <@575252669443211264> and appeal. You can also go to the report server.`)
